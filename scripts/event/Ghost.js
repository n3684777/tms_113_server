...
function playerEntry(eim, player) {
    ...
    eim.setProperty(player.getId() + "-Ghost_Point", "0");
...
function monsterDamaged(eim, chr, mobId, damage) {
    if (mobId == 9700037) {
        ...
        if ((b >= 2000000 && chr.getCarnivalParty().getTeam() == 1) || (r >= 2000000 && chr.getCarnivalParty().getTeam() == 0)) {
