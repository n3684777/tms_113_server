...
/***********************************************/
var 遠征怪物名稱     = "西格諾斯";
var boss             = "CygnusBattle";
var bossId           = 8850011;
var bossMapId        = 271041100;
var endMapId         = 271041000;
var map              = null;
var endMap           = null;
...
function monsterValue(eim, mobId) {	
	...
	if (mobId == 8850000 || mobId == 8850001  || mobId == 8850002 || mobId == 8850003) {
		...
		var mob5 = em.getMonster(bossId);
		eim.registerMonster(mob5);
		map.spawnMonsterOnGroundBelow(mob5, new java.awt.Point(-363, 100));
		eim.broadcastPlayerMsg(5, ""+遠征怪物名稱+"..！ 顯現出他的蹤跡！！");
	} else if (mobId == bossId) {
		clearPQ(eim);	
	}
    return 1;
}
...
function monsterDamaged(eim, player, mobId, damage){
	...
	if(mobId != 8850000  &&  mobId != 8850001  &&  mobId != 8850002  &&  mobId != 8850003  &&  mobId != 8850004  &&  mobId != 8850011) return;
	if(damage < 0){
		damage = 2147483000;
	}
