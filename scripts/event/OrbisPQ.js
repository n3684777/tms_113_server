...
var stg2_combo1 = Array("0", "0", "1", "0", "1");
...
function setup(eim, leaderid) {
    ...
    em.setProperty("stage6", "0");
    for (var b = 0; b < stg6_combo.length; b++) {
        for (var y = 0; y < 4; y++) {
...
function changedMap(eim, player, mapid) {
    ...
    } else if (mapid == 920011100 && em.getProperty("done").equals("0")) {
