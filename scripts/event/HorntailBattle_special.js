...
/***********************************************/
var 遠征怪物名稱     = "特殊闇黑龍王";
var boss            = "HorntailBattle_special";
...
function adjust(eim){
   if(map_1 == null){
		...
		eim.setProperty("special", "1");
		var mapFactory = eim.getMapFactory();
		map_1 = mapFactory.getMap(hole1);
		map_2 = mapFactory.getMap(hole2);
		map_3 = mapFactory.getMap(hole3);
		eim.setProperty("A頭血量", A頭血量);
        eim.setProperty("B頭血量", B頭血量);
        eim.setProperty("C頭血量", C頭血量);
        eim.setProperty("左手血量", 左手血量);
        eim.setProperty("右手血量", 右手血量);
        eim.setProperty("翅膀血量", 翅膀血量);
        eim.setProperty("腿血量", 腿血量);
        eim.setProperty("尾巴血量", 尾巴血量);
        eim.setProperty("本體血量", 本體血量);
			if(map_1 !=null){
				map_1.resetFully();
			}
			if(map_2 !=null){
...
function monsterDamaged(eim, player, mobId, damage){
	...
	if(mobId != 8810109 && mobId != 8810107 && mobId != 8810108 && mobId != 8810106 && mobId != 8810105 && mobId != 8810104 && mobId != 8810102 &&  mobId != 8810103 &&  mobId != 8810118 ) return;
...
function monsterValue(eim, mobId) {
   switch(mobId){
      case 8810100: //打死左頭顱 start 設 2
         eim.setProperty("start", "2");
         break;
      case 8810101: //打死右頭顱 start 設 3
