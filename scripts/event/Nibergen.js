...
var boss             = "Nibergen";
var bossId           = 9400273;
var bossMapId        = 802000611;
var endMapId         = 802000610;
var map              = null;
var endMap           = null;
...
function monsterValue(eim, mobId) {//每當有怪物被消滅
   ...
   if(stage.equals("1") && mobId == 9400278){
      eim.setProperty("start", "2");
      var mob = em.getMonster(9400271);
      eim.registerMonster(mob);
      map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(410, 274));
	  eim.broadcastPlayerMsg(5, ""+遠征怪物名稱+"..！ 顯現出他的蹤跡！！");
   }else if(stage.equals("2") && mobId == bossId){
...
function clearPQ(eim) {
	...
	map.spawnNpc(9120026, new java.awt.Point(13, 173));
