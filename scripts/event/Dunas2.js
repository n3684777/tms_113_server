...
var boss             = "Dunas2";
var bossId           = 9400294;
var bossMapId        = 802000711;
var endMapId         = 802000710;
var map              = null;
var endMap           = null;
...
function monsterValue(eim, mobId) {//每當有怪物被消滅
   var stage = eim.getProperty("start");

   if(stage.equals("1") && mobId == 9400293){
      eim.setProperty("start", "2");
      var mob = em.getMonster(9400294);
      eim.registerMonster(mob);
      map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-1787, 335));
	  eim.broadcastPlayerMsg(5, ""+遠征怪物名稱+"..！ 顯現出他的蹤跡！！");
   }else if(stage.equals("2") && mobId == 9400294){
...
function monsterDamaged(eim, player, mobId, damage){
	...
	if(mobId != 9400293 && mobId != 9400294 ) return;
	if(damage < 0){
		damage = 2147483000;
	}
...
function adjust(eim) {
   if(map == null){
	  ...
	  var 召喚反應怪 = em.getMonster(9400293);
	  eim.registerMonster(召喚反應怪);
	  map.spawnMonsterOnGroundBelow(召喚反應怪, new java.awt.Point(-829, 43));
...
function clearPQ(eim) {
	...
	map.spawnNpc(9120026, new java.awt.Point(-829, 43));
