...
var boss             = "Vergamot";
var bossId           = 9400265;
var bossMapId        = 802000211;
var endMapId         = 802000210;
var map              = null;
var endMap           = null;
...
function monsterValue(eim, mobId) {//每當有怪物被消滅
   ...
   if(stage.equals("1") && mobId == 9400276){
      eim.setProperty("start", "2");
      var mob = em.getMonster(9400263);
      eim.registerMonster(mob);
      map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(559, 545));
   }else if(stage.equals("2") && mobId == 9400263){
      eim.setProperty("start", "3");
   }else if(stage.equals("3") && mobId == 9400264){
      eim.setProperty("start", "4");
   }else if(stage.equals("4") && mobId == 9400265){
      eim.setProperty("start", "5");
      clearPQ(eim);
   }
...
function monsterDamaged(eim, player, mobId, damage){
	...
	if(mobId != 9400276 && mobId != 9400263 && mobId != 9400263 && mobId != 9400264 && mobId != 9400265) return;
	if(damage < 0){
		damage = 2147483000;
	}
...
function clearPQ(eim) {
	...
	map.spawnNpc(9120026, new java.awt.Point(156, 258));
