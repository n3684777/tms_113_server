...
var boss             = "Aufhaven";
var bossId           = 9400377;
var bossMapId        = 802000821;
var endMapId         = 802000820;
var map              = null;
var endMap           = null;
...
function monsterValue(eim, mobId) {//每當有怪物被消滅
	...
	if(stage.equals("1") && mobId == 9400376){
      var mob = em.getMonster(9400377);
      eim.registerMonster(mob);
      map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-1, 177));
   }
   return 1;
}
