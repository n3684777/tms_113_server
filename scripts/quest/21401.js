...
function end(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (qm.getPlayerStat("RSP") > (qm.getPlayerStat("LVL") - 120) * 3) {
            ...
            if (qm.getJob() != 2112) {
                qm.changeJob(2112);
				qm.teachSkill(21120004, 0, 10);
				qm.teachSkill(21120005, 0, 10);
				qm.teachSkill(21120006, 0, 10);
				qm.teachSkill(21120007, 0, 10);
				qm.worldMessage(2,"[" + qm.getChannelServer().getServerName() + "] : " + "玩家 " + qm.getChar().getName() + " 成功狂狼勇士四轉讓我們熱烈的祝福他/她吧！");
