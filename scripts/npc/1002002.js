...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 0) {
            ...
            status = 4;
            cm.sendNext("你一定好奇什麼是 #bVIP 到黃金海灘的票#k. 哈哈，這是非常可以理解的。貴賓門票到弗洛裡納海灘是一個項目在哪裡，只要你在身上，你可以用自己的方式來弗洛裡納海灘免費。那就是，即使我們不得不買這些，但不幸的是我在我的寶貴的暑假失去了一個雷幾週前這樣一個難得的道具.");
        }
    } else if (status == 2) {
        if (cm.getMeso() < 1500) {
        ...
        cm.sendNext("你一定好奇神麼是 #bVIP 到黃金海灘的票#k. 哈哈，這是非常可以理解的。貴賓門票到弗洛裡納海灘是一個項目在哪裡，只要你在身上，你可以用自己的方式來弗洛裡納海灘免費。那就是，即使我們不得不買這些，但不幸的是我在我的寶貴的暑假失去了一個雷幾週前這樣一個難得的項目.");
    } else if (status == 5) {
