...
function start() {
    ...
    if (cm.haveItem(ticketId)) {
        cm.sendYesNo("如看到這段請通知gmYou may use Gachapon. Would you like to use your Gachapon ticket?");
    } else {
        cm.sendSimple("如看到這段請通知gmWelcome to the " + cm.getPlayer().getMap().getMapName() + " Gachapon. How may I help you?\r\n\r\n#L0#What is Gachapon?#l\r\n#L1#Where can you buy Gachapon tickets?#l");
    }
}
