...
function action(mode, type, selection) {
	...
	if (Math.floor(Math.random() * 300) == 0) {
	    var rareList = new Array(2022217, 2022221, 2022222, 2022223,2022216, 2022218, 2022219, 2022220);
       item = rareList[Math.floor(Math.random() * rareList.length)];
		 cm.gainItem(item, 1);
	    ...
	    var itemList = new Array(2022216, 2022218, 2022219, 2022220, 2022217, 2022221, 2022222, 2022223, 2022216, 2022218, 2022219, 2022220);
