...
function start() {
    switch (cm.getMapId()) {
        ...
        case 802000803:
            ...
            break;
        default:
            cm.sendSimple("嗨~ 我是水晶，需要我幫忙？ \r #b#L0##m802000200##l \r #L1##m802000300##l \r #L2##m802000500##l \r #L3##m802000600##l \r #L5##m802000700##l  \r #L7##m802000800##l \r #L6#讓我好好考慮一下。#l");
            break;
    }
}
    ...
    if (selection != 6) {
        ...
        switch (selection) {
            ...
            case 5:
                ...
                break;
            case 7:
                questid = cm.getQuestStatus(50003) == 2;
                mapid = 802000800;
                portal = 0;
                break;
        }
