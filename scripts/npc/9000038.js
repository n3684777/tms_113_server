...
var levels = ["#m970030001#", "#m970030002#", "#m970030003#", "#m970030004#", "#m970030005#", "最終階段"];
...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if (status == 0) {
                        var sendStr = "#bBOSS挑戰賽副本#k  的獎勵取決於攻略的距離。請注意 #b獎勵只會給予在休息點離開的玩家#k. 挑戰更強的BOSS將會要求玩家攻略到下個休息點，或是擊倒最終BOSS。\r\n\r\n各個休息點的獎勵如下:\r\n\r\n#b";
                        for(var i = 0; i < 6; i++) {
                        ...
                        var sendStr = "下列獎勵將會在該階段給予 #b" + levels[selection] + "#k:\r\n\r\n";
