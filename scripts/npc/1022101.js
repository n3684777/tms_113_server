    ...
    if (status == 0) {
        ...
        if (firstsel == 2) {
            ...
            if (selection == 0) {
                ...
                cm.removeAll(1002225);
                cm.removeAll(1082101);
                cm.removeAll(1702210);
                cm.removeAll(1012007);
                cm.removeAll(1051131);
                cm.removeAll(1050019);
                cm.removeAll(1002720);
                cm.removeAll(1071003);
                cm.removeAll(1702008);
                cm.removeAll(1050119);
            }
            cm.dispose();
        } else {
