...
var mapName = ["Henesys00", "Ellinia01", "Perion02", "Kerning City03", "Sleepywood04", "Mushroom Shrine05", "Showa Spa (M)06", "Showa Spa (F)07", "Ludibrium08", "New Leaf City09", "El Nath010", "Nautilus011", "Âà³J«Î12"];
var curMapName = "";

function start() {
    status = -1;
	curMapName = mapName[(cm.getNpc() != 9330119 ) ? (cm.getNpc() != 9100117 && cm.getNpc() != 9100109) ? (cm.getNpc() - 9100100) : cm.getNpc() == 9100109 ? 9 : 11: 12];
    ...
    if (mode < 0)
        ...
        if (status == 0 && mode == 1) {
			if (cm.haveItem(ticketId)) {
				cm.sendYesNo("001You may use the " + curMapName + " Gachapon. Would you like to use your Gachapon ticket?");
			} else {
				cm.sendSimple("002Welcome to the " + curMapName + " Gachapon. How may I help you?\r\n\r\n#L0#What is Gachapon?#l\r\n#L1#Where can you buy Gachapon tickets?#l");
			}
