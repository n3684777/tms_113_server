...
var mob1 = [[2100001, 1, A, txt1],[2100002, 1, A, txt1],
...
var mob4 = [[2101081, 1, E, txt5],[2101081, 1, E, txt5]];

var mob5 = [[2101081, 1, E, txt5], [2101081, 1, E, txt5]];
	...
	if (status == 0) {
		...
		switch (selection) {
                ...
                for (var i = 0; i < storeInfo.length; ++i) {
                    ...
                    storeText += "#L" + i + "##v" + wepId + "# - #z" + wepId + "#  #r需要" + cost + "個" + item2 + " #l\r\n\r\n";
                }
		...
		cm.sendSimple("那麼，你想要做哪種形狀的五子棋呢？？\r\n#b#L11##t4080000##l#k\r\n#b#L12##t4080001##l#k\r\n#b#L13##t4080002##l#k\r\n#b#L14##t4080003##l#k\r\n#b#L15##t4080004##l#k\r\n#b#L16##t4080005##l#k");	
			...
			if(cm.haveItem(purchaseitem, purchaseCost)){
				cm.sendYesNo("您確定要兌換 #i" + purchaseId + "#  ?  \r\n兌換後您會剩餘的楓葉數目為 #r#e" + (cm.itemQuantity(purchaseitem) - purchaseCost) + " 個#t" + purchaseitem + "##k#n .");
			}else{
