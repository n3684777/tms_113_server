...
var 製造材料 = [
[4460000, 1, 兌換物, 2500], [4460002, 1, 兌換物, 1], [4460003, 1, 兌換物, 1] ,
[4460004, 1, 兌換物, 1],
];

var 娛樂虛寶 = [
[2250000, 1, 兌換物, 1000], [2250001, 1, 兌換物, 3000],
];
		...
		if (status == 0) {
            ...
            if (store) {
                ...
                for (var i = 0; i < storeInfo.length; ++i) {
                    ...
                    storeText += "#L" + i + "##v" + wepId + "# - #z" + wepId + "##r 【"+ wepIdcost +"】#k 個 - #r#z" + Item + "# #k "+Itemcost+" 片 #l\r\n";
                }
			...
			if(返回){
				...
				cm.getPlayer().addActive(log, purchaseItemCost * 自訂數值);
			}
		}else if (status == 5) {
			cm.dispose();
			cm.openNpc(9010000, 腳本路徑);
