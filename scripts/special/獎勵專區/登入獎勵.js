...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		var choice = "       #e#d您好冒險者，以下為" + log + "獎勵內容#b\r\n\r\n\r\n";
		for (var i = 0; i < prize.length; i++)
			choice += "          【 #i" + prize[i][0] + "# 】 #t" + prize[i][0] + "# #r" + prize[i][1] + 
			" #b個\r\n\r\n" + 
			...
			"\r\n\r\n";
		if (point[1] > 0) {
			choice += point[0] == 1 ? "            【 "+楓點圖案+" 】 Gash點數  #r" + point[1] + " #b點 " : "           【 "+楓點圖案+" 】 楓葉點數 #r" + point[1] + " #b點\r\n\r\n";
		}
		if (楓幣 > 0) {
			choice += "           【 "+楓幣圖案+" 】 楓幣 #r"+楓幣 / 10000+" #b萬\r\n";
		}
		choice += "\r\n";	
		if (紅利點數 > 0) {
			choice += "          【 "+紅利圖案+" 】 紅利 #r"+紅利點數+" #b點";
		}
		choice += "\r\n\r\n\r\n\r\n";				
